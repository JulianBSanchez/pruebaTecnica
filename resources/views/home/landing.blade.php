...
<h3 class="text-center" >Géneros Literarios</h3>
    ...
    <a href="{{ route('categoria.create') }}" class="btn btn-primary mb-4" >Agregar nueva categoria</a>
    <div class="my-4"></div>
    <h3 class="text-center" >Calendario de pedidos</h3>
    <full-calendar></full-calendar>
    <a href="{{ route('producto.create') }}" class="btn btn-primary">Agregar un nuevo pedido</a>
@endsection
